  ...
  <div class="container-fluid bg-cover" id="dekripsi" style="margin-top:0px;">
    ...
    <div class="col-md-12">
      <form method="post" enctype="multipart/form-data">
        <label>Masukan gambar yang terenkripsi:</label>
        <div class="form">
          ...
          <div class="">
            ...
            <input type="text" name="iv" class="form-control" placeholder="IV">
          </div><br>
  ...
  <div id="dekripsi" class="container-fluid bg-1" style="margin-top:0px;">
    <div class="col-md-12">
      ...
      if (isset($_POST['submit'])) {
        $iv = hex2bin($_POST['iv']);
        $plaintext = dekripsi(file_get_contents($_FILES['gambar']['tmp_name']));
      ?>
        <br>
        <img style="" border="0" src="data:image/jpeg;base64,<?php echo base64_encode($plaintext); ?>" class="img-thumbnail img-responsive">
    </div>
  <?php
      }
  ?>
